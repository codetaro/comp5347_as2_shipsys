...
public class Package {
	...
	/**
	 * When shopping system create a package through RESTful 
	 * web service in shipping system. This constructor was
	 * actually been called by PackageDaoDBImpl. So, It must
	 * be invokable!
	 * 
	 */
